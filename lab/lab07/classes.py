...
class InstructorCard(Card):
    ...
    def effect(self, opponent_card, player, opponent):
        ...
        opponentcopy = opponent.deck.cards[:]
        for card in player.deck.cards:
            card.attack += opponent_card.attack
            card.defense += opponent_card.defense
        for removecard in opponentcopy:
            if removecard.attack == opponent_card.attack and removecard.defense == opponent_card.defense:
                opponent.deck.cards.remove(removecard)
        # You should add your implementation above this.
